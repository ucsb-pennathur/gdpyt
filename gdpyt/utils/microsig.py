...
def image_spherical(mic, xp, P1):
    ...
    """print("Lens radius: {}".format(lens_radius))
    print("distance lens-CCD: {}".format(dCCD))
    print("distance particle-lens: {}".format(dPART))"""
    ...
    # print("Radius of Curvature of Lens: {}".format(rk))
