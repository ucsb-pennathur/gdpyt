...
class GdpytInceptionRegressionNet(nn.Module):
    ...
    def __init__(self, inception_classes, aux_logits=False):
        ...
        self.inception = GdpytInception3(num_classes=inception_out, aux_logits=aux_logits, init_weights=True)
...
class GdpytInception3(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=True,
        ...
        self.Mixed_7a = inception_d(768) # Output 1280 channels
        # Size reduction for GDPyT
    ...
    def _forward(self, x):
        ...
        # Skip last blocks to reduce size
        # x = self.Mixed_7b(x)
        # N x 2048 x 8 x 8
        # x = self.Mixed_7c(x)
        # N x 2048 x 8 x 8
