...
import pandas as pd
import numpy as np
from skimage.morphology import disk, square, octagon

# ----- ----- ----- ----- DEFINE PARAMETERS ----- ----- ----- ----- ----- ----- -----

# define file paths
CALIB_IMG_PATH = '/Users/mackenzie/Desktop/gdpyt-characterization/datasets/JP-EXF01-20/Calibration/Calibration-noise-level2/Calib-0050'
CALIB_BASE_STRING = 'B000'
CALIB_GROUND_TRUTH_PATH = 'standard_gdpt'
CALIB_ID = 'JP-EXF01-Calibration-noise-level2'
...
TEST_IMG_PATH = '/Users/mackenzie/Desktop/gdpyt-characterization/datasets/JP-EXF01-20/Dataset_I/Measurement-grid-noise-level2/Images'
TEST_BASE_STRING = 'B00'
TEST_GROUND_TRUTH_PATH = '/Users/mackenzie/Desktop/gdpyt-characterization/datasets/JP-EXF01-20/Dataset_I/Measurement-grid-noise-level2/Coordinates'
TEST_ID = 'JP-EXF01-Measurement-noise-level2'
TEST_RESULTS_PATH = '/Users/mackenzie/Desktop/gdpyt-characterization/datasets/JP-EXF01-20/Results/Dataset_I/gdpyt analysis of parameters'
...
GdpytCharacterize.test(calib_settings, test_settings)