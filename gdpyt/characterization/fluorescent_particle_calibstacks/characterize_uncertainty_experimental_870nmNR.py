...
# define filepaths
CALIB_PATH = '/Users/mackenzie/Desktop/gdpyt-characterization/calibration/calib_07.08.21_870nmNR/20X_on_glass'
CALIB_RESULTS_PATH = '/Users/mackenzie/Desktop/gdpyt-characterization/calibration/calib_07.08.21_870nmNR/results/glass'

EXPORT_RESULTS_PATH = '/Users/mackenzie/Desktop/gdpyt-characterization/calibration/calib_07.08.21_870nmNR/results/glass'
...
# dataset information
N_CAL = 36
MEASUREMENT_DEPTH = 36
MEASUREMENT_WIDTH = 793.6
TRUE_NUM_PARTICLES_PER_IMAGE = 83
...
MIN_P_AREA = 1  # minimum particle size (area: units are in pixels) (recommended: 5)
MAX_P_AREA = 500  # maximum particle size (area: units are in pixels) (recommended: 200)
...
CALIB_PROCESSING = {'none': {'args': []}} # {'median': {'args': [disk(MEDIAN_DISK), None, 'wrap']}}
...
CALIB_ID = 'Calib-870nmNileRed-'
SAVE_CALIB_ID = 'Calib-870nmNileRed-'
CALIB_IMG_PATH = CALIB_PATH
CALIB_IMG_STRING = 'nilered870nm_'
...
calib_set = calib_col.create_calibration(name_to_z, dilate=True, min_num_layers=3)  # Dilate: dilate images to slide template
...
if SAVE_CALIB_PLOTS or SHOW_CALIB_PLOTS:
    ...
    plot_calib_col_imgs = [ 'nilered870nm_1.tif', 'nilered870nm_4.tif', 'nilered870nm_8.tif', 'nilered870nm_14.tif',
                            'nilered870nm_16.tif', 'nilered870nm_24.tif', 'nilered870nm_27.tif', 'nilered870nm_30.tif']
