...
DATASET = '10.11.21-BPE_Pressure_Deflection_10X'
TESTSET = 'z0um'
...
MAX_P_AREA = 700  # maximum particle size (area: units are in pixels) (recommended: 200)
...
TEST_PARTICLE_ID_IMAGE = 'test_X2.tif'
...
# if meta-characterization on calibration image collection: method for converting filenames to z-coordinates
"""name_to_z_test = {}
...
test_settings = GdpytSetup.GdpytSetup(test_inputs, test_outputs, test_processing, z_assessment=test_z_assessment, optics=optics)
# test collection
test_col1 = GdpytImageCollection(folder=test_settings.inputs.image_path,
                                filetype=test_settings.inputs.image_file_type,
                                image_collection_type=test_settings.inputs.image_collection_type,
                                file_basestring=test_settings.inputs.image_base_string,
                                calibration_stack_z_step=calib_settings.inputs.calibration_z_step_size,
...
# Infer the z-height of each particle
test_col1.infer_z(calib_set, infer_sub_image=test_settings.z_assessment.sub_image_interpolation).sknccorr(
    min_cm=test_settings.z_assessment.min_cm, use_stack=None)
...
test_settings = GdpytSetup.GdpytSetup(test_inputs, test_outputs, test_processing, z_assessment=test_z_assessment, optics=optics)
# test collection
test_col2 = GdpytImageCollection(folder=test_settings.inputs.image_path,
                                filetype=test_settings.inputs.image_file_type,
                                image_collection_type=test_settings.inputs.image_collection_type,
                                file_basestring=test_settings.inputs.image_base_string,
                                calibration_stack_z_step=calib_settings.inputs.calibration_z_step_size,
...
# Infer the z-height of each particle
test_col2.infer_z(calib_set, infer_sub_image=test_settings.z_assessment.sub_image_interpolation).sknccorr(
    min_cm=test_settings.z_assessment.min_cm, use_stack=None)
...
# test collection
test_col3 = GdpytImageCollection(folder=test_settings.inputs.image_path,
                                filetype=test_settings.inputs.image_file_type,
                                image_collection_type=test_settings.inputs.image_collection_type,
                                file_basestring=test_settings.inputs.image_base_string,
                                calibration_stack_z_step=calib_settings.inputs.calibration_z_step_size,
...
# Infer the z-height of each particle
test_col3.infer_z(calib_set, infer_sub_image=test_settings.z_assessment.sub_image_interpolation).sknccorr(
    min_cm=test_settings.z_assessment.min_cm, use_stack=None)
...
# test collection
test_col4 = GdpytImageCollection(folder=test_settings.inputs.image_path,
                                filetype=test_settings.inputs.image_file_type,
                                image_collection_type=test_settings.inputs.image_collection_type,
                                file_basestring=test_settings.inputs.image_base_string,
                                calibration_stack_z_step=calib_settings.inputs.calibration_z_step_size,
...
# Infer the z-height of each particle
test_col4.infer_z(calib_set, infer_sub_image=test_settings.z_assessment.sub_image_interpolation).sknccorr(
    min_cm=test_settings.z_assessment.min_cm, use_stack=None)
...
# test: z 5000 um
del test_col4
TESTSET = 'z5000um-maybe3750butprobnot'
TEST_IMG_PATH = join(BASE_DIR, 'images/test', TESTSET)
test_inputs = GdpytSetup.inputs(dataset=DATASET,
                                image_collection_type='test',
                                image_path=TEST_IMG_PATH,
...
# test collection
test_col5 = GdpytImageCollection(folder=test_settings.inputs.image_path,
                                filetype=test_settings.inputs.image_file_type,
                                image_collection_type=test_settings.inputs.image_collection_type,
                                file_basestring=test_settings.inputs.image_base_string,
                                calibration_stack_z_step=calib_settings.inputs.calibration_z_step_size,
...
# Infer the z-height of each particle
test_col5.infer_z(calib_set, infer_sub_image=test_settings.z_assessment.sub_image_interpolation).sknccorr(
    min_cm=test_settings.z_assessment.min_cm, use_stack=None)
